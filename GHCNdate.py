...
data = pd.read_csv(r'D:\Nick\Documents\Scripts\pcpinput.csv', index_col=0, squeeze=True)
...
new_header = ['19400101']
data.to_csv(r'D:\Nick\Documents\Scripts\pcpout.csv', header=new_header, index=None, mode='w')
